 ...
 */
package Vista;
import Controlador.CtrlListarVentas;
import Modelo.ArchivoTexto;

public class FrmListarVentas extends javax.swing.JFrame {
    
    CtrlListarVentas objCtrlListarVentas;
    ArchivoTexto ObjArch;
    
    public FrmListarVentas() {
        initComponents();
        this.objCtrlListarVentas = new CtrlListarVentas( this);
        this.listarVentas();
    }
    public void listarVentas() {
        String[] columnas = {"Fecha", "Producto", "Cantidad", "Total"};
        this.objCtrlListarVentas.listarVentas(columnas);
    }
    ...
    private void initComponents() {
        ...
        tblListarVentas.setBackground(new java.awt.Color(220, 253, 245));
    ...
    public javax.swing.JTable tblListarVentas;
